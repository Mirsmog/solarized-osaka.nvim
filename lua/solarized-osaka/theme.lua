...
function M.setup()
  ...
  theme.highlights = {
    ...
    Normal = { fg = c.base0, bg = options.transparent and c.none }, -- normal text
    NormalNC = { fg = c.base00, bg = options.transparent and c.none }, -- normal text in non-current windows
    ...
    NavicIconsKey = { fg = c.violet500 },
    NavicIconsKeyword = { fg = c.violet500 },

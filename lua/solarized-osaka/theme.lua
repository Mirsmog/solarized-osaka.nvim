...
function M.setup()
  ...
  theme.highlights = {
    ...
    -- navic
    NavicIconsFile = { fg = c.fg, bg = c.fg_float },
    NavicIconsModule = { fg = c.yellow, bg = c.fg_float },
    NavicIconsNamespace = { fg = c.fg, bg = c.fg_float },
    NavicIconsPackage = { fg = c.fg, bg = c.fg_float },
    NavicIconsClass = { fg = c.orange, bg = c.fg_float },
    NavicIconsMethod = { fg = c.blue, bg = c.fg_float },
    NavicIconsProperty = { fg = c.cyan, bg = c.fg_float },
    NavicIconsField = { fg = c.cyan, bg = c.fg_float },
    NavicIconsConstructor = { fg = c.orange, bg = c.fg_float },
    NavicIconsEnum = { fg = c.orange, bg = c.fg_float },
    NavicIconsInterface = { fg = c.orange, bg = c.fg_float },
    NavicIconsFunction = { fg = c.blue, bg = c.fg_float },
    NavicIconsVariable = { fg = c.magenta, bg = c.fg_float },
    NavicIconsConstant = { fg = c.magenta, bg = c.fg_float },
    NavicIconsString = { fg = c.green, bg = c.fg_float },
    NavicIconsNumber = { fg = c.orange, bg = c.fg_float },
    NavicIconsBoolean = { fg = c.orange, bg = c.fg_float },
    NavicIconsArray = { fg = c.orange, bg = c.fg_float },
    NavicIconsObject = { fg = c.orange, bg = c.fg_float },
    NavicIconsKey = { fg = c.violet500, bg = c.fg_float },
    NavicIconsKeyword = { fg = c.violet500, bg = c.fg_float },
    NavicIconsNull = { fg = c.orange, bg = c.fg_float },
    NavicIconsEnumMember = { fg = c.cyan, bg = c.fg_float },
    NavicIconsStruct = { fg = c.orange, bg = c.fg_float },
    NavicIconsEvent = { fg = c.orange, bg = c.fg_float },
    NavicIconsOperator = { fg = c.fg, bg = c.fg_float },
    NavicIconsTypeParameter = { fg = c.cyan, bg = c.fg_float },
    NavicText = { fg = c.fg, bg = c.fg_float },
    NavicSeparator = { fg = c.fg, bg = c.fg_float },
